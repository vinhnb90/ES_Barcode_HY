 ...
 */
public class DsGhimCtoFragment extends BaseFragment {
    ...
    private OnDsGhimCtoFragmentInteractionListener mListener;
    private DsCongToAdapter mAdapter;

    public DsGhimCtoFragment() {
...
//        this.isDsCtoGhim = isDsCtoGhim;
    ...
    public interface OnDsGhimCtoFragmentInteractionListener {
        // TODO: Update argument type and name
        List<CongToProxy> interactionDataGhimCongTo();
