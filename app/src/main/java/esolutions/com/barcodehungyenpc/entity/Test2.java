...
public class Test2 implements KvmSerializable {
    ...
    public String NGAY_NHAP_HT;
    public String NGAY_NHAP;
    public String NAM_SX;
    public String LOAI_SOHUU;
    public String TEN_SOHUU;
    public String MA_BDONG;
    public String NGAY_BDONG;
    public String NGAY_BDONG_HTAI;
    ...
    public String CHISO_THAO;
    public String HSN;
    public String NGAY_GUI_GKDCT_MTB;
    ...
    public void setProperty(int index, Object value) {
        switch (index) {
            case 0:
                CHON = Integer.parseInt(value.toString());
                break;
            case 1:
                STT = Integer.parseInt(value.toString());
                break;
            case 2:
