...
/**
 * Created by VinhNB on 9/25/2017.
 */

public class Update_GuiKD_CTO_MTBResponse {
    ...
    @SerializedName("NGAY_BDONG_HT")
    @Expose
    private String NGAY_BDONG_HT;
    @SerializedName("NGAY_GUI_GKDCT_MTB")
    @Expose
    private String NGAY_GUI_GKDCT_MTB;
    @SerializedName("NGAY_KDINH")
    @Expose
    private String NGAY_KDINH;
    @SerializedName("NGAY_NHAP_MTB")
    @Expose
    ...
    public int getIDBBGKD() {
        return IDBBGKD;
    }

    public void setIDBBGKD(int IDBBGKD) {
        this.IDBBGKD = IDBBGKD;
    }
    ...
    public String getNGAY_BDONG_HT() {
        return NGAY_BDONG_HT;
    }

    public void setNGAY_BDONG_HT(String NGAY_BDONG_HT) {
        this.NGAY_BDONG_HT = NGAY_BDONG_HT;
    }
